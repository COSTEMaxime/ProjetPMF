...
/*	public void alerteRosee (boolean Up){
		if (Up == false){
...
//				setTemperatureConsigne(getTemperatureConsigne()+1);
		...
		iconAlertDown.setIcon(new ImageIcon("C:\\Users\\Pierre GILLY\\workspace\\Mini-frigo\\src\\Vue\\pouce_down.jpg"));
		iconAlertDown.setBounds(521, 393, 118, 123);
		frame.getContentPane().add(iconAlertDown);
		
		JLabel lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\Pierre GILLY\\workspace\\Mini-frigo\\src\\Vue\\Free-Desktop-Solid-Color-HD-Wallpapers.jpg"));
