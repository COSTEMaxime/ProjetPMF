...
public class View implements IView {
	...
	private void initialize() {
		...
		outTemperatureConsigne = new JLabel("");
		...
		lessButton.setBounds(365, 86, 79, 46);
		frame.getContentPane().add(lessButton);

		outHumidity = new JLabel("");
		...
		plusButton.setBounds(365, 34, 79, 46);
		...
		iconAlertUp.setIcon(new ImageIcon("src/View/pouce_up.png"));
		...
		iconAlertDown.setIcon(new ImageIcon("src/View/pouce_down.jpg"));
		...
		backgroundLabel.setIcon(new ImageIcon(View.class.getResource("/view/Free-Desktop-Solid-Color-HD-Wallpapers.jpg")));
		backgroundLabel.setBounds(0, 0, 682, 553);
